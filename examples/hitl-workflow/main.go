...
func run() error {
	...
	kit, err := brainkit.New(brainkit.Config{
		...
		Modules: append(standard.PackageSet(), workflowmod.New()),
	})
	if err != nil {
	...
	if _, err := packageclient.Deploy(ctx, kit, packageclient.Inline("hitl-workflow-demo", "wf.ts", workflowSource)); err != nil {

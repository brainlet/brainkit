// Package sqlite provides the SQLite audit store without linking other audit
// store backend drivers.
package sqlite
...
// Store persists audit events in a SQLite database. Column names match
...
// New opens a SQLite audit store. WAL mode + NORMAL sync + 5s

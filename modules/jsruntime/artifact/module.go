// Package artifact provides an artifact-only JS runtime module variant.
package artifact
...
// Module enables the embedded JavaScript runtime without a TypeScript source
// preparer. It accepts normalized JavaScript artifacts and rejects raw .ts
// source deploys with a clear error.
type Module struct{}
...
// New creates the artifact-only JS runtime module. The module ID is still
// "jsruntime" so JS-dependent modules can use their normal dependency.
...
func (m *Module) Describe() bkmodule.Descriptor {
	return describe("jsruntime")
}

// Factory is the registered ModuleFactory for the artifact-only runtime.
type Factory struct{}
...
func (Factory) Describe() bkmodule.Descriptor {
	return describe("jsruntime_artifact")
}

func describe(name string) bkmodule.Descriptor {
	return bkmodule.Descriptor{
		Name:    name,
		Status:  bkmodule.StatusBeta,
		Summary: "Embedded JavaScript runtime activation for normalized JavaScript artifacts.",
		Provides: []string{
			"jsruntime",
		},
...
func init() { bkmodule.Register("jsruntime_artifact", Factory{}) }

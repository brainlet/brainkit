...
// execSync
const echoResult = child_process.execSync("echo hello-brainkit");
const echoStr = typeof echoResult === "string" ? echoResult : echoResult.toString("utf8");

// execFileSync
const fileResult = child_process.execFileSync("echo", ["file-sync-test"]);
const fileStr = typeof fileResult === "string" ? fileResult : fileResult.toString("utf8");

// spawnSync
const spawnResult = child_process.spawnSync("echo", ["spawn-sync-test"]);

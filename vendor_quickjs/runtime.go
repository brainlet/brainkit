...
func (r *Runtime) Close() {
	...
	// Step 5: Release the OS thread that was locked in NewRuntime().
	// Without this, each NewRuntime()/Close() cycle permanently consumes an OS thread,
	// leading to thread exhaustion and stack address space issues after many cycles.

...
// TestFullStack_NATS_Postgres_RBAC exercises a production-realistic stack:
// NATS transport, Postgres storage, persistence, RBAC, and tracing.
func TestFullStack_NATS_Postgres_RBAC(t *testing.T) {

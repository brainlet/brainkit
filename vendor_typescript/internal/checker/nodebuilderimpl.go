...
import (
	...
	"github.com/brainlet/brainkit/vendor_typescript/internal/collections"
	...
	"github.com/brainlet/brainkit/vendor_typescript/internal/module"
	"github.com/brainlet/brainkit/vendor_typescript/internal/modulespecifiers"
	"github.com/brainlet/brainkit/vendor_typescript/internal/nodebuilder"
	"github.com/brainlet/brainkit/vendor_typescript/internal/printer"
	"github.com/brainlet/brainkit/vendor_typescript/internal/pseudochecker"
	"github.com/brainlet/brainkit/vendor_typescript/internal/scanner"
	"github.com/brainlet/brainkit/vendor_typescript/internal/stringutil"
...
func (b *NodeBuilderImpl) serializeTypeForDeclaration(declaration *ast.Declaration, t *Type, symbol *ast.Symbol, tryReuse bool) *ast.Node {
	...
	if tryReuse && b.ctx.enclosingDeclaration != nil && declaration != nil && (ast.IsAccessor(declaration) || (ast.HasInferredType(declaration) && !ast.NodeIsSynthesized(declaration) && (t.ObjectFlags()&ObjectFlagsRequiresWidening) == 0)) {

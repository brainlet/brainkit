...
func (r *Runtime) registerLoggingBridge(qctx *quickjs.Context) {
...
func (r *Runtime) throwBrainkitError(qctx *quickjs.Context, err error) *quickjs.Value {
...
func (r *Runtime) enrichHandlerErr(qctx *quickjs.Context, fallback error) error {

...
type Store interface {
	// Modules
	SaveModule(name string, binary []byte, info ModuleInfo) error
	LoadModules() (map[string]*Module, error)
...
// ---------------------------------------------------------------------------
// SQLiteStore — pure Go SQLite-backed Store
// ---------------------------------------------------------------------------
...
// SQLiteStore implements Store using pure Go SQLite (modernc.org/sqlite).
...
func (s *SQLiteStore) SaveModule(name string, binary []byte, info ModuleInfo) error {
...
func (s *SQLiteStore) LoadModules() (map[string]*Module, error) {
